# ADR-0016: 协议与 repo 整体改名 scaffold → Gearbox

- Date: 2026-07-19
- 溯源: 回流自 [gearbox ADR-0015](https://github.com/real-stanyan/gearbox/blob/master/docs/adr/0015-rename-to-gearbox.md)（gearbox-update 工具同步）
- Status: accepted
