# ADR-0020: ADR-0012 判据的定义豁免——CONTEXT.md 词条描述既有机制不触发 L1

- Date: 2026-07-19
- 溯源: 回流自 [gearbox ADR-0019](https://github.com/real-stanyan/gearbox/blob/master/docs/adr/0019-definition-exemption-for-context-glossary.md)（gearbox-update 工具同步）
- Status: accepted
