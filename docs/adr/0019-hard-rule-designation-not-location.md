# ADR-0019: Hard rule 按标注定级,不按住址——Hard rules 节占位符保留 + 加注

- Date: 2026-07-19
- 溯源: 回流自 [gearbox ADR-0018](https://github.com/real-stanyan/gearbox/blob/master/docs/adr/0018-hard-rule-designation-not-location.md)（gearbox-update 工具同步）
- Status: accepted
...
- **c(把散落硬规则收编/复述进节)**:同一规则活两处,违反单一事实源——协议第一原则不该被协议自己破坏。ADR-0015 刚填掉"下游清单硬编码"这类坑,不再挖
