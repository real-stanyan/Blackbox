# ADR-0015: PR 模板引用 DOWNSTREAM.md 清单,不硬编码下游项目名

- Date: 2026-07-19
- 溯源: 回流自 [gearbox ADR-0014](https://github.com/real-stanyan/gearbox/blob/master/docs/adr/0014-pr-template-references-downstream-list.md)（gearbox-update 工具同步）
- Status: accepted
