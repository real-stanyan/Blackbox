# ADR-0024: 协议版本号——semver 变体 tag + 下游戳记

- Date: 2026-07-19
- 溯源: 回流自 [gearbox ADR-0023](https://github.com/real-stanyan/gearbox/blob/master/docs/adr/0023-protocol-version-scheme.md)（gearbox-update 工具同步,上游 sha256:2062f3795ff4）
- Status: accepted
...
- **major**:跨工具/跨 repo 契约变更——hash 戳记格式(ADR-0022)、install 锚点结构(ADR-0023)、文件布局、改名。下游回流需人工干预
