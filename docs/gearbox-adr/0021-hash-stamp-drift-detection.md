# ADR-0022: 同步工具加 hash 戳记——已同步 ADR 的上游漂移可检测

- Date: 2026-07-19
- 溯源: 回流自 [gearbox ADR-0021](https://github.com/real-stanyan/gearbox/blob/master/docs/adr/0021-hash-stamp-drift-detection.md)（gearbox-update 工具同步,上游 sha256:51488bbfd17b）
- Status: accepted
