# ADR-0026: gearbox-update 开跑防呆——报告豁免 / 自动切 main / --force-redo

- Date: 2026-07-20
- 溯源: 回流自 [gearbox ADR-0025](https://github.com/real-stanyan/gearbox/blob/master/docs/adr/0025-update-preflight-ergonomics.md)（gearbox-update 工具同步,上游 sha256:96045cf2da59）
- Status: accepted
- 关联: ADR-0018(gearbox-update)、ADR-0025(--refresh-drift)
...
- 分级:纯工具行为(ADR-0018 先例),不动 AGENTS.md;issue #53 + 本 ADR + PR,CI 绿自主 merge;Version bump: minor
