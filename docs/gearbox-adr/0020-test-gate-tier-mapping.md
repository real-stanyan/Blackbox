# ADR-0021: 测试型门禁的分层映射——配置层套 0010,内容层按动机定级

- Date: 2026-07-19
- 溯源: 回流自 [gearbox ADR-0020](https://github.com/real-stanyan/gearbox/blob/master/docs/adr/0020-test-gate-tier-mapping.md)（gearbox-update 工具同步）
- Status: accepted
...
- **残余空间(接受)**:「对应产品代码变更」的判定有主观余地(重构大挪移时对应关系模糊)。兜底同 ADR-0020:拿不准按 L1 + 维护者事后否决权
